<template>
  <div class="min-h-screen bg-[#f8f9fd] flex flex-col justify-between font-sans text-gray-800">
    <header class="w-full bg-white border-b border-gray-100 px-6 py-4 flex justify-between items-center">
      <div class="text-blue-700 font-bold text-xl tracking-tight">WorkspaceAuth</div>
      <a href="#" class="text-gray-500 hover:text-gray-700 text-sm">Support</a>
    </header>
    <main class="flex-grow flex items-center justify-center p-4">
      <div class="bg-white rounded-xl shadow-sm border border-gray-50 p-8 max-w-md w-full text-center">
        ...
        <div class="flex justify-center gap-2 mb-6">
          <input
            ...
            :class="activeIndex === index ? 'border-blue-600 ring-1 ring-blue-600' : 'border-gray-200'"
        ...
        <p class="text-xs text-gray-500">
          ...
          <a href="#" @click.prevent="resendCode" class="text-blue-600 hover:underline">Resend Code</a>
        </p>
      </div>
    </main>

    <footer class="w-full bg-white border-t border-gray-100 px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-gray-500">
